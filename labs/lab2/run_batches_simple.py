...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=4, help="Tests per batch (default: 4 for Lab 2)")
    ...
    parser.add_argument("--tests", type=str, default="_generated/tests_flat.yaml", help="Test file to split (default: _generated/tests_flat.yaml)")
